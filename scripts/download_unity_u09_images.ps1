...
$map = @{
    "애니메이션1.png" = "unity_u09_animator_state_machine.png"
    "애니메이션3.png" = "unity_u09_animator_transition_inspector.png"
}
...
Write-Host "U09 Image copy and script validation complete."
