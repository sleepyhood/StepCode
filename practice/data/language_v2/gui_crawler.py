...
class CrawlerApp:
    def __init__(self, root):
        ...
        tk.Label(root, text="[ 타겟 도메인 ]", font=("Helvetica", 10, "bold")).pack(
            pady=(15, 5)
        )
        ...
        self.doingcoding_options_frame = tk.Frame(root)
        ...
        self.admin_frame.pack(pady=(0, 10))
        ...
        self.log_area = scrolledtext.ScrolledText(
            root, width=75, height=10, state="disabled", bg="#f0f0f0"
        )
    ...
    def _set_doingcoding_option_visibility(self):
        if self.domain_var.get() == "doingcoding":
            self.doingcoding_options_frame.pack(before=self.frame_dir, pady=(0, 10))
            return
