...
![Unity Console 창 예시 (Debug.Log 출력 확인)](./data/theory/images/unity_u02_log_operator_console.png)
...
- `%`는 나머지 연산자다. `i % 2 == 0`은 짝수 판별 표준식이다.
- Unity 콘솔 출력은 `Debug.Log("...");`를 사용한다.

![Unity Console Stack Trace 예시 (로그 상세 확인)](./data/theory/images/unity_u02_log_operator_console_stacktrace.png)
...
![Unity Console 줄 수 조절 예시](./data/theory/images/unity_u02_log_operator_console_linecount.png)
...
![MonoBehaviour 메시지 흐름도 (이벤트 함수 맥락)](./data/theory/images/unity_u02_log_operator_monobehaviour_flow.svg)
