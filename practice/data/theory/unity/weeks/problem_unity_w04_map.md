...
|---|---|---|---:|---|
| X01 | 객관식 | null 안전 접근(삼항 연산) | 1, 10 | 단일 구문 내에서 참조 타입 객체의 null 여부를 체크한 뒤 분기 처리하는 방어 코딩 능력 검증 |
| X02 | 객관식 | 타입 비교 가능성 판별 | 37 | 컬렉션 간 비교 불가를 인지하고 숫자형 변형들의 정상적인 대소 호환 비교를 구분해 내는 문법 구별력 함양 |
