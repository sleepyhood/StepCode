...
ph_matches = list(re.finditer(r'\[이미지 삽입: (IMG_W04_\d{3})\]', md_content))
...
for m in ph_matches:
    ...
    # Using a slightly refined alt text approach to avoid repeating the prompt phrasing
...
# output to a new file so we can view it
out_file = r'C:\Users\osw\Desktop\Workspace\#Projects\StepCode\practice\data\theory\canva\Week04\final_match4.json'
