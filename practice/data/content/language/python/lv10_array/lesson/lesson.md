...
lang: "python"
categoryId: "py_array"
title: "Python Lv10 배열"
status: "active"
order: 210
audience: "common"
recommendedSetId: "py_lv10_array_b01"
relatedSetIds: ["py_lv10_array_b01", "py_lv10_array_b02", "py_lv10_array_b03", "py_lv10_array_c01", "py_lv10_array_c02"]
prerequisites: ["py_lv09_nfor"]
nextConcepts: ["py_lv15_array2d"]
priority: 3
---
# 배열 핵심 이론
...
Python에서는 엄밀히 리스트(list)지만, 이 문서에서는 학습 편의를 위해 "배열(리스트)"로 통일해 설명합니다.
...
![배열 인덱스-값 매핑](./data/theory/images/array_index_mapping.svg)
...
![배열 순회 흐름](./data/theory/images/array_traversal_flow.svg)
...
패턴 B와 같은 순회를 사용하되, `sumv`와 `maxv` 두 상태를 함께 추적하는 방식입니다.
...
{lang:python,c,java} 주의: `maxv = arr[0]` 방식은 배열 길이가 1 이상일 때 사용합니다.
...
한 줄 체크: `len = 4`이면 마지막 인덱스는 `3`입니다.
