...
class MyMax {
    public 빈칸 max(int first, int second) {
		if (first > second)
			return first;
		else
			return second;
    ...
    public 빈칸 max(double first, double second) {
		if (first > second)
			return first;
		else
			return second;
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(my.max(1, 2));
        System.out.println(my.max(3.14, 62.8));
    }
}
