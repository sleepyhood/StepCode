...
| **06**  | 수업     | **규칙 기반 열거**   | [로마 숫자 만들기](02_workspace/ALLv10006_2139.md)         | `ALLv10006`  | **2139**  | `ALLv10003`       |   `[ ]`    | 상태 공간의 체계적 열거                   |
|         | 숙제     |                | [숫자 카드 조합](02_workspace/SALLv10006_LOCAL.md)        | `SALLv10006` | **LOCAL** | _(신규)_            |   `[ ]`    | 상태 공간의 확장                       |
| **07**  | 수업     | **구조적 점화식**    | [정사각형 쌓기](02_workspace/ALLv10007_2137.md)           | `ALLv10007`  | **2137**  | `ALLv10004`       |   `[ ]`    | 구조적 패턴의 점화식                     |
|         | 숙제     |                | [타일 채우기 (2×N)](02_workspace/SALLv10007_LOCAL.md)    | `SALLv10007` | **LOCAL** | _(신규)_            |   `[ ]`    | 분할 정복 기초                        |
| **08**  | 수업     | **조합론 기초**     | [로또](02_workspace/ALLv10008_2136.md)                | `ALLv10008`  | **2136**  | `ALLv10005`       |   `[ ]`    | 조합(nCr)의 재귀적 구현                 |
