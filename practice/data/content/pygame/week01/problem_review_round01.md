...
> 현재 웹/인덱스 기준 주차 루트는 `practice/data/content/pygame/week01/`입니다.
...
`1~2주차를 묶은 세트 1 초안`으로 해석한다.
다만 현재 문제 구성은 `1주차 개념 복습`에 더 가깝기 때문에,
우선은 `1주차 필수 문제 + 심화 문항` 구조로 검수한다.

이 문서는 공통 원칙 문서인
`../pygame_문제_제작_운영원칙.md`를 따른다.
이 문서에는 1주차 세부 문항과 검수 내용을 중심으로 기록한다.
